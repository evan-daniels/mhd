...
void CENTPACK::mesh(const double& x_init, const double& x_final, doublearray1d& x, doublearray1d& x_cell, doublearray1d& dx_cell, doublearray1d& dx_interface, const int& id, const int& p)
{
	long j, l, J, L;
	double dx;
	double xid0, xidf;
